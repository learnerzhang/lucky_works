...
from utils.dl_utils import read_corpus, batch_yield, read_target_test_corpus, persist, read_dict
...
def args():
    ...
    parser.add_argument('--DEMO', type=str, default='tf_cnn_emergency', help='model for test and demo')
